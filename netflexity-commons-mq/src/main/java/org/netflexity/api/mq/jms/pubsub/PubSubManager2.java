 ...
 */
public class PubSubManager2 implements PubSub {

    // Singleton instance.
    private static PubSub instance;
    public static Logger logger = Logger.getLogger(PubSubManager2.class);
     ...
     * @param clientId
     */
    PubSubManager2(String clientId) {
    ...
    public static synchronized PubSub getInstance(String clientId) {
        if (instance == null) {
            instance = new PubSubManager2(clientId);
        }
        return instance;
    }
