 ...
 *
 */
public class IBMMbFlowStatsConsumer implements JMSConsumerObject{
    
    private MbSubscription subscription;
    private MbMessageBroker broker;
    
    /**
     * @param subscription
     */
    public IBMMbFlowStatsConsumer(MbSubscription subscription, MbMessageBroker broker) {
    ...
    public String getDestinationName() {
        return IBMMbArtifactBuilderFactory.createArtifactBuilder(subscription.getSubscriptionType())
            .getTopicName(subscription.getSubscriptionObject());
    }
