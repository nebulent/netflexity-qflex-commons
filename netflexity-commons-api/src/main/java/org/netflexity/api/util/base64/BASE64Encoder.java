package org.netflexity.api.util.base64;
...
public class BASE64Encoder {
    ...
    private char mapByteToChar(byte b) {
        if (b < LOWER_CASE_A_VALUE) { return (char) ('A' + b); }
    ...
    /**
     * Simple test method to make sure everything works correctly Creates 100
     * randomly sized arrays of random bytes, encodes them, decodes them, and
     * checks to make sure the result matches the input
     */
