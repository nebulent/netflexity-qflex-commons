 ...
 *
 */
public class StringMessageSource implements MessageSource {

    private static final Log logger = LogFactory.getLog(StringMessageSource.class);
    ...
    public StringMessageSource(Reader reader) {
